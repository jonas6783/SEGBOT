...
ein Tiefenbild des Bauteils auf, schneidet per KI (YOLO findet das Bauteil,
SAM zeichnet die genaue Silhouette) alles Drumherum weg und speichert das
...
CONF_THRESHOLD = 0.9
# Erkannte Silhouette um so viele Pixel nach aussen vergroessern (0 = aus):
EXPAND_PIXELS = 0
