...
CAD_PATH = "../config/bauteil.ply"                 # unser CAD-Modell (PLY/STL)
...
NOISE_MAX_DIST_FROM_CAD = 0.005   # Punkte weiter als 5 mm vom CAD fliegen

#  ERWARTEN wir  Abweichungen wie Angussreste
# gilt stattdessen die groessere Zonen-Toleranz:
ZONE_RADIUS = 0.003
ZONE_MAX_DIST_FROM_CAD = 0.0050
